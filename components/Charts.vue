<template>
    <div class="px-4 flex flex-col space-y-4">
      ...
      <div class="p-4 bg-[#1E1E1E] rounded-lg shadow-md mb-8">
        ...
        <div class="mt-4 flex justify-center space-x-4" ref="barChartLegend"></div>
      </div>
      ...
      <div class="p-4 bg-[#1E1E1E] rounded-lg shadow-md">
        ...
        <div class="mt-4 flex justify-center space-x-4" ref="donutChartLegend"></div>
      </div>
    </div>
  </template>
          ...
          if (donutChartLegend.value) {
            ...
            donutChartData.labels.forEach((label, index) => {
              ...
              colorBox.style.backgroundColor =
                donutChartData.datasets[0].backgroundColor[index] as string;
